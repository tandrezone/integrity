...
/* check.html.twig */
class __TwigTemplate_31a4c60a387980f38ce495c37004a52f46393f1daae0b51a29c177628441b7ea extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"POST\" action=\"analize\">
    ...
    ";
        // line 29
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["chars"]) || array_key_exists("chars", $context) ? $context["chars"] : (function () { throw new RuntimeError('Variable "chars" does not exist.', 29, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["char"]) {
            // line 30
            echo "        <tr>
            <td>";
            // line 31
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["char"], 0, [], "array", false, false, false, 31), "html", null, true);
            echo "</td>
            <td>";
            // line 32
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["char"], 1, [], "array", false, false, false, 32), "html", null, true);
            echo "</td>
        </tr>
    ";
        }
...
";
    ...
    {
        return array (  158 => 35,  149 => 32,  145 => 31,  142 => 30,  138 => 29,  120 => 13,  114 => 12,  105 => 9,  100 => 8,  95 => 7,  90 => 6,  88 => 5,  78 => 4,  59 => 3,  36 => 1,);
    }
